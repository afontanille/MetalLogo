...
public class MetalRenderer : NSObject {
    ...
    func makePipeline() throws {
        ...
        let vertexFunc = try getShaderWithFunction("vertex_project")
        let fragmentFunc = try getShaderWithFunction("fragment_flatcolor")
    ...
    func getShaderWithFunction(funcName: String) throws -> MTLFunction? {
        let path = NSBundle.mainBundle().pathForResource("logo", ofType: "metal")
        let input: String?
